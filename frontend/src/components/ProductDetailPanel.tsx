...
export default function ProductDetailPanel({
  ...
  return (
    <div className="flex-1 lg:pl-4">
      <h1 className="font-domine text-[#222] text-2xl font-bold mb-2">{name}</h1>
      ...
      <div className="flex flex-row gap-3 mb-6">
        <a
          ...
          className="flex flex-1 min-w-0 items-center justify-center gap-2 bg-[#25D366] text-white font-bold py-3 px-4 rounded-full hover:bg-[#128C7E] transition-colors uppercase tracking-widest text-[11px] sm:text-[12px]"
        >
