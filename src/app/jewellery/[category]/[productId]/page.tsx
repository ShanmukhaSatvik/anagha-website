        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-8 mt-8">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
            ...
            <div className="w-full lg:w-[45%] flex flex-col items-center">
              ...
              {/* Certification Logos */}
              <div className="mt-16 flex items-center justify-center gap-8 border-t border-gray-100 pt-8 w-full">
                <div className="flex flex-col items-center">
                   <p className="text-[9px] text-gray-400 uppercase mb-3 tracking-widest font-bold">Certified By</p>
                   <div className="flex items-center gap-10">
                      <div className="flex flex-col items-center gap-1.5">
                        <img src="/images/certifications/bis.png" alt="BIS Hallmark" className="h-8 w-auto transition-transform hover:scale-110 cursor-help" title="BIS Hallmark" />
                        <span className="text-[10px] font-bold text-black uppercase tracking-tight">BIS hallmark</span>
                      </div>
                      <img src="/images/certifications/sgl.webp" alt="SGL" className="h-8 w-auto transition-transform hover:scale-110 cursor-help" title="SGL Certified" />
                      <img src="/images/certifications/igi.jpg" alt="IGI" className="h-8 w-auto transition-transform hover:scale-110 cursor-help" title="IGI Certified" />
                      <div className="flex items-center gap-1">
                        <img src="/images/certifications/gsi.jpg" alt="GSI" className="h-8 w-auto transition-transform hover:scale-110 cursor-help" title="GSI Certified" />
                        <span className="text-[24px] font-bold text-[#2e6da4] uppercase italic tracking-tighter leading-none">GSI</span>
                      </div>
                   </div>
                </div>
              </div>
            ...
            <div className="flex-1 lg:pl-4">
              ...
              <div className="flex items-center gap-2.5 bg-[#fff5f5] border border-[#ffebeb] p-2.5 rounded-md mb-4">
                ...
                <p className="text-[12px] text-[#222] leading-tight">
                  {product.offer} <span className="text-[#2e6da4] font-medium cursor-pointer ml-0.5">*TCA</span>
                </p>
              </div>
