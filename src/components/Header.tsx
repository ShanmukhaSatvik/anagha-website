...
const NAV = [
  'RINGS', 'EARRINGS',
  'PENDANTS', 'HARAM', 'VADDANAM', 'BANGLES', 'SOLITAIRES', 'ALL JEWELLERY',
];
        ...
        <div className="flex items-end h-[76px] pl-[110px] xl:pl-[130px] pr-4 xl:pr-10 pb-[10px]">
          ...
          <div className="flex flex-col items-end ml-auto shrink-0 gap-y-[3px]">
            ...
            <div className="flex items-center h-[33px]">
              ...
              <Link href="#" className="flex flex-row items-center justify-center gap-1.5 text-[#25D366] font-semibold text-[10px] xl:text-[12px] leading-tight cursor-pointer whitespace-nowrap w-auto xl:w-[110px]">
                <WhatsAppIcon />
                <span>Connect<br />With Us</span>
              </Link>
              <span className={VDIV} />
              {/* Locate Store */}
              <div className="flex flex-row items-center justify-center gap-1.5 text-[#f1592a] font-semibold text-[10px] xl:text-[12px] leading-tight cursor-pointer whitespace-nowrap w-auto xl:w-[110px]">
                <PinIcon />
            ...
            >
              {(() => {
                const NAV_LINKS: Record<string, string> = {
                  ...
                  'HARAM': '/jewellery/haram',
                  'VADDANAM': '/jewellery/vaddanam',
                ...
                <div className="absolute top-full left-1/2 -translate-x-1/2 bg-white shadow-2xl w-[700px] py-10 rounded-b-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-[100] border-t-2 border-navy translate-y-2 group-hover:translate-y-0">
                  <div className="px-12 grid grid-cols-2 gap-12 text-left">
                    ...
                    <div className="flex flex-col">
                      <div>
                        <h4 className="text-navy font-bold text-[15px] mb-5 border-b border-gray-300 pb-2">By Categories</h4>
              ...
              {n === 'HARAM' && (
                <div className="absolute top-full left-1/2 -translate-x-1/2 bg-white shadow-2xl w-[700px] py-10 rounded-b-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-[100] border-t-2 border-navy translate-y-2 group-hover:translate-y-0">
                  <div className="px-12 grid grid-cols-2 gap-12 text-left">
                    ...
                    {/* Column 2: By Categories + Callout */}
                    <div className="flex flex-col">
                      <div>
                        <h4 className="text-navy font-bold text-[15px] mb-5 border-b border-gray-300 pb-2">By Categories</h4>
                        <ul className="space-y-3 mb-10">
                          {[
                            { name: 'Guttapusala Haram', slug: 'guttapusala-haram' },
                            { name: 'Kasulaperu Haram', slug: 'kasulaperu-haram' },
                            { name: 'Pachala Haram', slug: 'pachala-haram' },
                            { name: 'Nakshi Haram', slug: 'nakshi-haram' },
                            { name: 'Gundla Haram', slug: 'gundla-haram' },
                          ].map(item => (
                            <li key={item.name}>
                              <Link href={`/jewellery/haram#${item.slug}`} className="text-[#334155] text-[13px] hover:text-[#f1592a] transition-colors">{item.name}</Link>
                            </li>
                          ))}
                        </ul>
                      </div>
                      <div className="mt-auto border-t border-gray-300 pt-6 flex items-center gap-4 group/callout cursor-pointer overflow-hidden">
                        <div className="flex-1">
                          <h5 className="text-navy font-bold text-[14px] group-hover/callout:text-[#f1592a] transition-colors">Shop Silver Haram</h5>
                          <p className="text-gray-500 text-[12px]">Explore our collection</p>
                        </div>
                        <div className="w-32 h-28 shrink-0">
                          <img src="/images/header/silver-haram.jpg" alt="Silver Haram" className="w-full h-full object-contain object-right" />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="px-12 grid grid-cols-2 gap-12 text-left">
                    ...
                    <div className="flex flex-col">
                      <div>
                        <h4 className="text-navy font-bold text-[15px] mb-5 border-b border-gray-300 pb-2">By Categories</h4>
                        <ul className="space-y-3 mb-10">
                          {['Lakshmi Vaddanam', 'Nakshi Vaddanam', 'Peacock (Mayil) Vaddanam', 'Polki Vaddanam', 'Lightweight Vaddanam'].map(item => (
                            <li key={item} className="text-[#334155] text-[13px] hover:text-[#f1592a] transition-colors cursor-pointer">{item}</li>
                          ))}
                        </ul>
                      </div>
                      <div className="mt-auto border-t border-gray-300 pt-6 flex items-center gap-4 group/callout cursor-pointer overflow-hidden">
                        <div className="flex-1">
                          <h5 className="text-navy font-bold text-[14px] group-hover/callout:text-[#f1592a] transition-colors">Shop Silver Vaddanam</h5>
                          <p className="text-gray-500 text-[12px]">Explore our collection</p>
                        </div>
                        <div className="w-24 h-20 shrink-0">
                          <img src="/images/header/silver-vaddanam.png" alt="Silver Vaddanam" className="w-full h-full object-contain object-right" />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="px-12 grid grid-cols-2 gap-12 text-left">
                    ...
                    <div className="flex flex-col">
                      <div>
                        <h4 className="text-navy font-bold text-[15px] mb-5 border-b border-gray-300 pb-2">By Categories</h4>
                        <ul className="space-y-3 mb-10">
                          {['Nakshi Bangles', 'Kundan Bangles', 'Glass Bangles', 'Antique Finish Bangles', 'Meenakari Bangles'].map(item => (
                            <li key={item} className="text-[#334155] text-[13px] hover:text-[#f1592a] transition-colors cursor-pointer">{item}</li>
                          ))}
                        </ul>
                      </div>
                      <div className="mt-auto border-t border-gray-300 pt-6 flex items-center gap-4 group/callout cursor-pointer overflow-hidden">
                        <div className="flex-1">
                          <h5 className="text-navy font-bold text-[14px] group-hover/callout:text-[#f1592a] transition-colors">Shop Silver Bangles</h5>
                          <p className="text-gray-500 text-[12px]">Explore our collection</p>
                        </div>
                        <div className="w-24 h-20 shrink-0">
                          <img src="/images/header/silver-bangle.jpg" alt="Silver Bangle" className="w-full h-full object-contain object-right" />
                        </div>
                      </div>
                    </div>
                  </div>
